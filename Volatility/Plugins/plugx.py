...
signatures = {
    'namespace1': 'rule plugx { \
                       ...
                       $v2b = { 68 A0 02 00 00 } \
                       $v2k = { C1 8F 3A 71 } \
                    condition: $v1a at 0 or $v1b or (($v2a or $v2b) and (($v1algoa and $v1algob) or $v2k)) }'
}
...
class PlugXConfig(PlugXScan):
    ...
    def parse_config(self, cfg_blob, cfg_sz, outfd):
        if cfg_sz in (0xbe4, 0x150c, 0x1510, 0x1b18, 0x1d18, 0x2540, 0x170c):
            ...
            # Persistence
            if cfg_sz in (0x1b18, 0x1d18, 0x2540, 0x170c):
